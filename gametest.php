...
<body>
	<div class="container-fluid" id="division" style="
			...
			<header>
				...
				<h3 class="text-center card-header">Welcome <?php echo $_SESSION['username']; ?> you've select only 1 out of 4. Best Of Luck <i class="far fa-smile-beam"></i></h3>
				<div class="container">
					<div class="col-lg-8 mx-auto d-block">
						<form method="post" action="gameResult.php">
							<?php
								...
								//QUESTIONS
								$q = "select * from gamequestions where qid = $i";
								$query = mysqli_query($con,$q);

								while ($rows = mysqli_fetch_array($query)) {
							?>	
							<div class="card">
								<h4 class="card-header">Q.<?php echo $rows['question'] ?></h4>		<?php
									//ANSWERS
									$q = "select * from gameanswers where ans_id = $i";
									$query = mysqli_query($con,$q);
